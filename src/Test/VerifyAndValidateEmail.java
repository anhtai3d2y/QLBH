 ...
 * @author acer
 */
public class VerifyAndValidateEmail extends javax.swing.JFrame {

    /**
     * Creates new form VerifyAndValidateEmail
     */
    public VerifyAndValidateEmail() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerifyAndValidateEmail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerifyAndValidateEmail().setVisible(true);
            }
        });
    }
